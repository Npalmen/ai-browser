...
export const INTERACTION_SYSTEM_PROMPT = [
  ...
  'Use cannot-complete when the requested action cannot be performed safely or the target cannot be found.',
  ...
  'Never claim that a browser action occurred unless TRUSTED_RUN_PROGRESS already records that action in this current task.',
